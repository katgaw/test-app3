...
async def generate_recipe(
    ...
    if not openai_api_key:
        raise HTTPException(status_code=500, detail="OpenAI API key not found. Please set OPENAI_API_KEY in your environment variables.")
    
    try:
        # Initialize OpenAI client without any proxy settings to avoid conflicts
